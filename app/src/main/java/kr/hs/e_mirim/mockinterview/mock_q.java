...
public class mock_q extends AppCompatActivity {
    ...
    private String[] club = {"30초 정도의 간단한 소개", "선배랑 트러블이 생긴다면?", "동아리에 지원하게 된 결정적인 이유", "이 공간에서 마음에 들지 않는 것은?", "우리 동아리 이름을 바꾸고 싶다면?",
                    ...
                    "동아리와 학교 이벤트가 겹친다면?"};
    private String[] company = {"30초 정도의 간단한 소개", "도전한 경험이나 목표한 것을 이룬 경험이 있나요?", "자신을 한 단어로 표현한다면 어떤 단어로 표현하고 싶나요?", "다른 회사에서 접근한다면 이직을 고려할 것인가요?", "입사 후 이루고 싶은 목표는?",
                    "현재까지 가장 의미있었던 프로젝트나 업적에 대해 말해보십시요.", "일을 하다보면 의견 충돌이나 갈등이 발생 될텐데 그럴 때는 어떻게 해결해 나가는 편인가요?", "왜 당신을 고용해야 하죠?", "5년 후의 당신의 모습은 어떨까요?", "혼자만 다른 의견을 가지고 있을 때, 어떻게 할 것인가요?",
                    "갈등을 해결해본 경험은?", "좌우명은 뭣인가요?"};
